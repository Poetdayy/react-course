...
function App() {
  return (
    ...
    //   </p>
    // </div>
    <Feature image="https://images.unsplash.com/photo-1524758631624-e2822e304c36?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"></Feature>
  );
}
...
function Feature(props) {
  return (
    <div className="youtube-item">
      <img src="{image}" alt="" className="youtube-background" />
